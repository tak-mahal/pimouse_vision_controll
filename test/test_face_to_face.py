...
class VisionTest(unittest, TestCase):
    ...
    def test_put_freq(self):
        ...
        self.assertFalse(turn is None,"direction is not fixed. l:" +\
                                      str(l_turn_rate) + " r:" + str(r_turn_rate))
        self.assertEqual(sys.argv[1], turn, "wrong direction. l:" +\
                                      str(l_turn_rate) +" r:" + str(r_turn_rate))

if __name__ =='__main__':
    rospy.init_node('test_face_to_face')
    rostest.rosrun('pimouse_vision_controll','test_face_to_face',VisionTest)
